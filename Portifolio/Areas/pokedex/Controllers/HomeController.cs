...
using Portifolio.Areas.Pokedex.Models;

namespace Portifolio.Areas.Pokedex.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        using (StreamReader leitor = new("Areas\\pokedex\\Data\\pokemons.json"))
        {
    ...
    {
        using (StreamReader leitor = new("Areas\\pokedex\\Data\\tipos.json"))
        {
            string dados = leitor.ReadToEnd();
